...
namespace WebApplication1.Models
{
    public partial class Model1 : DbContext
    {
        ...
        public virtual DbSet<sysdtscategory> sysdtscategories { get; set; }
        public virtual DbSet<sysdtspackagelog> sysdtspackagelogs { get; set; }
        public virtual DbSet<sysdtspackage> sysdtspackages { get; set; }
        public virtual DbSet<sysdtssteplog> sysdtssteplogs { get; set; }
        public virtual DbSet<sysdtstasklog> sysdtstasklogs { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<backupmediaset>()
                .HasMany(e => e.backupmediafamilies)
                .WithRequired(e => e.backupmediaset)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<backupmediaset>()
                .HasMany(e => e.backupsets)
                .WithRequired(e => e.backupmediaset)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<backupset>()
                .HasMany(e => e.backupfiles)
                .WithRequired(e => e.backupset)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<backupset>()
                .HasMany(e => e.backupfilegroups)
                .WithRequired(e => e.backupset)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<backupset>()
                .HasMany(e => e.restorehistories)
                .WithRequired(e => e.backupset)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<MSdbm>()
                .HasMany(e => e.MSdbms_datatype)
                .WithRequired(e => e.MSdbm)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<sysdbmaintplan>()
                .HasMany(e => e.sysdbmaintplan_databases)
                .WithRequired(e => e.sysdbmaintplan)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<sysdtscategory>()
                .HasMany(e => e.sysdtspackages)
                .WithRequired(e => e.sysdtscategory)
            ...
            modelBuilder.Entity<syssession>()
                .HasMany(e => e.sysjobactivities)
                .WithRequired(e => e.syssession)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<sysssispackage>()
                .HasMany(e => e.syscollector_collector_types_internal)
                .WithRequired(e => e.sysssispackage)
            ...
            modelBuilder.Entity<sysssispackage>()
                ...
                .WithRequired(e => e.sysssispackage1)
